-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\USER\Desktop\Farneback_blockRAM\blockram_v2\codegen\PolyExp_pipeline1\hdlsrc\PolyExp_pipeline1_fixpt_enb_bypass.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PolyExp_pipeline1_fixpt_enb_bypass
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY PolyExp_pipeline1_fixpt_enb_bypass IS
  PORT( clk_1                             :   IN    std_logic;
        reset_1                           :   IN    std_logic;
        clk_enable_1                      :   IN    std_logic;
        clk_enable_2                      :   OUT   std_logic
        );
END PolyExp_pipeline1_fixpt_enb_bypass;


ARCHITECTURE rtl OF PolyExp_pipeline1_fixpt_enb_bypass IS
